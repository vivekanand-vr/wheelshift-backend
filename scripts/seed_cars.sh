...
VALUES
  (
    ...
    28800,998,'AVAILABLE',
    (SELECT id FROM storage_locations WHERE name='MG Road Hub' LIMIT 1),
  ...
  (
    ...
    (SELECT id FROM storage_locations WHERE name='Hebbal Branch' LIMIT 1),
  ...
  (
    ...
    21500,999,'AVAILABLE',
    (SELECT id FROM storage_locations WHERE name='Electronic City Storage' LIMIT 1),
  ...
  (
    ...
    (SELECT id FROM storage_locations WHERE name='Whitefield Facility' LIMIT 1),
