...
SET @loc_mg_road   = @loc_mg_road;
SET @loc_hebbal    = @loc_hebbal;
SET @loc_elec_city = @loc_elec_city;
SET @loc_whitefield= @loc_whitefield;
...
VALUES
  (
    ...
    'Black',35000,2020,'2020-04-10','AVAILABLE',
    @loc_mg_road,
  ...
  (
    ...
    'Black Red',22000,2021,'2021-05-20','AVAILABLE',
    @loc_mg_road,
  ...
  (
    ...
    'Black Red',8500,2022,'2022-03-08','AVAILABLE',
    @loc_mg_road,
  ...
  (
    ...
    'Black Blue',28000,2020,'2020-06-25','AVAILABLE',
    @loc_mg_road,
  ...
  (
    ...
    'Matte Grey',18000,2021,'2021-07-14','AVAILABLE',
    @loc_mg_road,
  ...
  (
    ...
    'Metallic White',6500,2022,'2022-08-01','RESERVED',
    @loc_mg_road,
  ...
  (
    ...
    'Pearl Igneous Black',32000,2020,'2020-09-18','AVAILABLE',
    @loc_hebbal,
  ...
  (
    ...
    'Imperial Red Metallic',15000,2021,'2021-10-05','AVAILABLE',
    @loc_hebbal,
  ...
  (
    ...
    'Metallic Triton Blue',7500,2022,'2022-01-27','AVAILABLE',
    @loc_hebbal,
  ...
  (
    ...
    'Race Red',21000,2021,'2021-03-22','AVAILABLE',
    @loc_hebbal,
  ...
  (
    ...
    'Glory Black',30000,2020,'2020-11-12','SOLD',
    @loc_hebbal,
  ...
  (
    ...
    'Champion Black Blue',19000,2021,'2021-06-30','AVAILABLE',
    @loc_elec_city,
  ...
  (
    ...
    'Burnt Red',11000,2022,'2022-04-15','AVAILABLE',
    @loc_elec_city,
  ...
  (
    ...
    'Matte Red',9000,2022,'2022-02-18','AVAILABLE',
    @loc_elec_city,
  ...
  (
    ...
    'Imperial Red Metallic',38000,2020,'2020-07-08','AVAILABLE',
    @loc_elec_city,
  ...
  (
    ...
    'Cyan Burst',7000,2022,'2022-09-12','RESERVED',
    @loc_elec_city,
  ...
  (
    ...
    'Black White',51000,2019,'2019-08-22','AVAILABLE',
    @loc_whitefield,
  ...
  (
    ...
    'Black',42000,2020,'2020-05-05','SOLD',
    @loc_whitefield,
  ...
  (
    ...
    'Black Red',26000,2021,'2021-08-17','AVAILABLE',
    @loc_whitefield,
  ...
  (
    ...
    'Pearl Fadeless White',20000,2021,'2021-12-03','AVAILABLE',
    @loc_whitefield,
